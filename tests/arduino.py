...
def setUp(self):
    ...
    proc = None
    env = os.environ
    if not 'DISPLAY' in env or env['DISPLAY'] == '':
...
class ArduinoTest(unittest.TestCase):
    ...
    def expect_string(self, string):
        ...
        self.assertRegexpMatches(read, re.compile(string))
    ...
    def build(self, build_path):
        ...
        ret = Popen(["./arduino", "--verify", "--board",
                     ...
                     "build.path=" + tmp_path, build_path], env=env)
        ret.wait()
    ...
    def flash(self, flash_path):
        try:
            ret = call([COZYINSTALL, '-r', flash_path])
        except OSError:
            self.failIf(
    ...
    def do_run(self, path, regex, write=None):
        self.flash(self.build(path))
        if write:
            cereal.write(write)
        self.expect_string(regex)

    def test_01_string_addition_operators(self):
        self.do_run(
            "./examples/08.Strings/StringAdditionOperator/StringAdditionOperator.ino",
            '\\\n\\\nAdding\\ strings\\ together\\ \\(concatenation\\)\\:\\\n\\\r\\\n\\\rstringThree\\ \\=\\ 123\\\n\\\rstringThree\\ \\=\\ 123456789\\\n\\\rstringThree\\ \\=\\ A\\\n\\\rstringThree\\ \\=\\ abc\\\n\\\rstringThree\\ \\=\\ this\\ string\\\n\\\rSensor\\ value\\:\\ [0-9]{1,4}\\\n\\\rmillis\\(\\)\\ value\\:\\ [0-9]{1,3}\\\n\\\r')

    def test_02_string_replace(self):
        self.do_run("./examples/08.Strings/StringReplace/StringReplace.ino",
                    '\\\n\\\nString\\ \\ replace\\:\\\n\\\n\\\r\\\n\\\r\\<html\\>\\<head\\>\\<body\\>\\\n\\\rOriginal\\ string\\:\\ \\<html\\>\\<head\\>\\<body\\>\\\n\\\rModified\\ string\\:\\ \\<\\/html\\>\\<\\/head\\>\\<\\/body\\>\\\n\\\rnormal\\:\\ bookkeeper\\\n\\\rl33tspeak\\:\\ b00kk33p3r\\\n\\\r')

    # this test is ugly, but it is good to test every character can be expected
    def test_03_ascii_table(self):
        self.do_run("./examples/04.Communication/ASCIITable/ASCIITable.ino",
    ...
    def test_09_index_of(self):
        self.do_run("./examples/08.Strings/StringIndexOf/StringIndexOf.ino",
    ...
    def test_10_string_length(self):
        self.do_run("./examples/08.Strings/StringLength/StringLength.ino",
                    ...
                    write="asdf\rlkjasdl;fkjsdf\ranfoiauehjfoaisjef\r;asidjf;alsfdjioaijefoiasejasdfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff\rlkasdjciojaeoijfalsicjlaisdjfiajsdf\rjao;isdjcoaisdjaaid\r")
    ...
    def test_14_string_to_int(self):
        self.do_run("./examples/08.Strings/StringToInt/StringToInt.ino",
                    '\\\n\\\nString\\ toInt\\(\\)\\:\\\n\\\r\\\n\\\rValue\\:123\\\n\\\rString\\:\\ 123\\\n\\\rValue\\:55\\\n\\\rString\\:\\ 55\\\n\\\rValue\\:0\\\n\\\rString\\:\\ \\\n\\\rValue\\:858\\\n\\\rString\\:\\ 858\\\n\\\r',
